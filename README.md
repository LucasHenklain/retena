...
| `09_Kit_Banca_Final/` | Kit oficial da Banca Final (23/09/2026), versão comercial v3: deck de 18 slides + apêndice técnico A1–A15 (PPTX + PDF), guia do apresentador, one-pager com QR codes; deck técnico v2 preservado em `versao_anterior_tecnica/` | `Retena_Banca_Final.pptx` · `README.md` |
